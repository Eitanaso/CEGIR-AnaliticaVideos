...
class Objeto_Global:
    ...
    def create_contadores(self, lineas_contadores, texto_contadores, pos_texto, color):#, guardar_archivo):
        self.contadores = True
        self.objeto_Contadores = Objeto_Contadores(color, pos_texto)#guardar_archivo)
        self.objeto_Contadores.create_line_zones([lineas_contadores])
        self.objeto_Contadores.create_line_zone_annotators(texto_in=texto_contadores[0], texto_out=texto_contadores[1])
