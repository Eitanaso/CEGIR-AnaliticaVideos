...
class Objeto_Contadores:
    ...
    def create_line_zone_annotators(self, texto_in='↑ N° per', texto_out='↓ N° per'): # ← → ↑ ↓
        for i in range(self.n_contadores):
            anotador_lz = Anotador_Linea_Actualizado(thickness=1, text_thickness=1, text_scale=0.75, color = sv.Color.green(), text_color=sv.Color.white(), text_padding=1, text_offset=1,
