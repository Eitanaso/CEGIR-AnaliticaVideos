...
class Anotador_Linea_Actualizado(LineZoneAnnotator):
    ...
    def annotate(self, frame: np.ndarray, line_counter: LineZone, pos_texto, color) -> np.ndarray:
        """
        ...
        #in_text_x = int(200)
        in_text_x = 20
        in_text_x = pos_texto[0][0]

        in_text_y = int(20)
        #in_text_y = int(400)
        in_text_y = 380
        in_text_y = pos_texto[0][1]


        out_text_x = int(w+80)
        #out_text_x = int(200)
        out_text_x = 20
        out_text_x = pos_texto[1][0]

        out_text_y = int(in_text_y + out_text_height + 10)
        #out_text_y = int(430)
        out_text_y = 410
        out_text_y = pos_texto[1][1]
        ...
        draw.text((in_text_x, in_text_y), in_text, font=font, align='left', fill=color) # RGB
        draw.text((out_text_x, out_text_y), out_text, font=font, align='right', fill=color) # RGB
