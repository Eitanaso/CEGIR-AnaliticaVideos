import argparse
from detectar_conteo_ciclistas import run_detect, detect
...
variables = {
    ...
    'texto_contador': ['Cicl in-out', 'Cicl out-in'],
    'periodicidad_contador': 10,
    'nombre_contador': 'contador12h_2',
    'direccion_archivo': 'C:\\CEGIR-AnaliticaVideos-new_main\\conteo_ciclistas\\',
}
procesamiento = {
    'var_fijas': fijas,
    'info': datos,
