...
def main(model, i=0):
    ...
    while True:
        ...
        if (len(dets) > 0):
            ...
            cv2.imwrite(f'D:\\analitica_camara_CEGIR\\datos_autos_mal_estacionados\\{momento}.jpg', output_frame)
            datos = {
			"type": "GS",
            ...
            with open(f'D:\\analitica_camara_CEGIR\\datos_autos_mal_estacionados\\{momento}.json', 'w') as f:
                json.dump(datos, f)
            file_name = f'D:\\analitica_camara_CEGIR\\datos_autos_mal_estacionados\\{momento}.jpg'
