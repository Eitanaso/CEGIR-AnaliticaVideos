import argparse
from detectar_autos import detect
...
def main(model, i=0):
    ...
    while True:
        ...
        if (len(dets) > 0):
            ...
            cv2.imwrite(f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_autos_mal_estacionados\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg', output_frame)
            datos = {
            ...
            'nombre_calle1': user_inputs[3], 'nombre_calle2': user_inputs[4],
                ...
                'autos_mal_estacionados': len(dets),
            ...
            with open(f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_autos_mal_estacionados\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.json', 'w') as f:
                json.dump(datos, f)
            file_name = f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_autos_mal_estacionados\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg'
