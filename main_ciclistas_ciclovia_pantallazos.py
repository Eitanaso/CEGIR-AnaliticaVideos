...
def main(model, i=0):
    ...
    while True:
        ...
        cv2.imwrite(f'D:\\analitica_camara_CEGIR\\datos_ciclistas_ciclovia\\{momento}.jpg', output_frame)
        datos = {
			"type": "GS",
            'id_camara': user_inputs[0], 'sub_id_camara': user_inputs[1], 'nombre_calle1': user_inputs[2], 'nombre_calle2': user_inputs[3],
                ...
                'ciclistas_ciclovia': len(dets),
                'nombre_imagen': f'{momento}.jpg',
                }
        #IoTclient.publish(TOPIC, create_payload(datos), 0)
        with open(f'D:\\analitica_camara_CEGIR\\datos_ciclistas_ciclovia\\{momento}.json', 'w') as f:
            json.dump(datos, f)
        file_name = f'D:\\analitica_camara_CEGIR\\datos_ciclistas_ciclovia\\{momento}.jpg'
