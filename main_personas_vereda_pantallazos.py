...
def main(model, i=0):
    ...
    while True:
        ...
        cv2.imwrite(f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}.jpg', output_frame)
        datos = {
			"type": "GS",
        ...
        with open(f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}.json', 'w') as f:
            json.dump(datos, f)
        file_name = f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}.jpg'
