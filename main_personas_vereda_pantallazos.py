...
def main(model, i=0):
    ...
    while True:
        ...
        cv2.imwrite(f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg', output_frame)
        datos = {
            ...
            'nombre_calle1': user_inputs[3], 'nombre_calle2': user_inputs[4],
                ...
                'personas_vereda': len(dets),
                'nombre_imagen': f'{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg',
                }
        #descomentar al tener correcto la direccion de guardado de estos datos en AWS
        #IoTclient.publish(TOPIC, create_payload(datos), 0)
        with open(f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.json', 'w') as f:
            json.dump(datos, f)
        file_name = f'C:\\CEGIR-AnaliticaVideos-new_main\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg'
        key_name = f'{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg'
        #descomentar al tener direccion al s3 para guardar imagenes
