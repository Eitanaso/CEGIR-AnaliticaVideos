...
def main(model, i=0):
    ...
    while True:
        ...
        cv2.imwrite(f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg', output_frame)
        datos = {
        ...
        with open(f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.json', 'w') as f:
            json.dump(datos, f)
        file_name = f'D:\\analitica_camara_CEGIR\\datos_personas_vereda\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg'
