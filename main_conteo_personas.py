import argparse
from detectar_conteo_personas import run_detect, detect
...
variables = {
    ...
    'texto_contador': ['Per in-out', 'Per out-in'],
    'periodicidad_contador': 10,
    'nombre_contador': 'contador12h_2',
    'direccion_archivo': 'C:\\CEGIR-AnaliticaVideos-new_main\\conteo_personas\\',
}
procesamiento = {
    'var_fijas': fijas,
    'info': datos,
