...
def main(model, i=0):
    ...
    while True:
        ...
        if (prev_det == 0) and (prev_det < len(dets)):
            ...
            cv2.imwrite(f'D:\\analitica_camara_CEGIR\\datos_graffiti\\{momento}_{user_inputs[0]}_{user_inputs[1]}_{user_inputs[2]}_{user_inputs[3]}_{user_inputs[4]}.jpg', output_frame)
            datos = {
